...
L["25 Player Raid (Titan Reforged)"] = "25人团队副本（泰坦重铸）"
L["40 Man Raid"] = "40人团队"
...
L["Coilfang: Serpentshrine Cavern"] = "毒蛇神殿"
...
L["Set IDs can be found on websites such as wowhead.com/classic/item-sets"] = "套装ID可以在 wowhead.com/classic/item-sets 等网站上找到"
L["Set IDs can be found on websites such as wowhead.com/item-sets"] = "套装 ID 可以在一些数据网站上找到（例如：wowhead.com/item-sets）"
L["Set IDs can be found on websites such as wowhead.com/mop-classic/item-sets"] = "套装ID可以在 wowhead.com/mop-classic/item-sets 等网站上找到"
L["Set IDs can be found on websites such as wowhead.com/tbc/item-sets"] = "套装ID可以在 wowhead.com/tbc/item-sets 等网站上找到"
L["Set IDs can be found on websites such as wowhead.com/wotlk/item-sets"] = "套装ID可以在 wowhead.com/wotlk/item-sets 等网站上找到"
...
L["This aura is setting show to nil. This is deprecated and the behavior will change in the future."] = "这个光环正设定为显示nil。这是已弃用的方法，未来的行为将会改变。"
...
L["WeakAuras has detected empty settings. If this is unexpected, ask for assistance on https://discord.gg/weakauras."] = "WeakAuras 检测到设置项为空。如果这是意料之外的，请在 https://discord.gg/weakauras 上寻求帮助。"
