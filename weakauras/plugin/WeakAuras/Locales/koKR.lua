...
L["A trigger in this aura is set up to track a soft target unit, but you don't have the CVars set up for this to work correctly. Consider either changing the unit tracked, or configuring the Soft Target CVars."] = "이 위크오라의 활성 조건은 액션 대상 유닛을 추적하도록 설정되어 있으나 CVar 설정이 제대로 작동하도록 되어있지 않습니다. 추적할 유닛을 바꾸거나 액션 대상 지정 관련 CVar를 설정해야 합니다."
...
L["Down, then Left"] = "아래 다음 왼쪽으로"
L["Down, then Right"] = "아래 다음 오른쪽으로"
L["Dragonflight"] = "용군단"
L["Drain"] = "마력 소진"
...
L["Left, then Down"] = "왼쪽 다음 아래로"
L["Left, then Up"] = "왼쪽 다음 위로"
...
L["Right, then Down"] = "오른쪽 다음 아래로"
L["Right, then Up"] = "오른쪽 다음 위로"
L["Role"] = "역할"
...
L["This aura is setting show to nil. This is deprecated and the behavior will change in the future."] = "이 위크오라는 show 설정값이 nil로 되있습니다. 이러한 코드는 향후 사용할 수 없으며 코드 작동 방식이 변경될 예정입니다."
...
L["Up, then Left"] = "위쪽 다음 왼쪽으로"
L["Up, then Right"] = "위쪽 다음 오른쪽으로"
...
L["WeakAuras has detected empty settings. If this is unexpected, ask for assistance on https://discord.gg/weakauras."] = "WeakAuras에서 빈 설정이 감지되었습니다. 예상치 못한 상황이라면 https://discord.gg/weakauras에서 도움을 요청해 주세요."
