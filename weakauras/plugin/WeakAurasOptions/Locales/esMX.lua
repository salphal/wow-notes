...
-- WeakAuras/Options
	...
	L["|cFFffcc00Font Flags:|r"] = "|cFFffcc00Banderas de fuente:|r"
	L["|cFFffcc00Font Flags:|r none"] = "|cFFffcc00Banderas de fuente:|r ninguna"
...
Enable this setting if you want this timer to be hidden, or when using a WeakAuras text to display the timer]=] ] = "Un temporizador se mostrará automáticamente de acuerdo con la configuración predeterminada de la interfaz (anulada por algunos addons). Activa esta opción si quieres que el temporizador esté oculto, o cuando utilices un texto de WeakAuras para mostrar el temporizador."
	...
	L["Align"] = "Alinear"
	L["Aligned left"] = "Alineado a la izquierda"
	L["Aligned right"] = "Alineado a la derecha"
	...
	L["and shadow |c%sColor|r with offset |cFFFF0000%s/%s|r"] = "y sombra de |c%scolor|r con desplazamiento |cFFFF0000%s/%s|r"
	L["and smooth scaling"] = "y escalado suave"
...
every 3 events starting from 2nd and ending at 11th: 2-11/3]=] ] = "Ocurrencia del evento, se reinicia cuando se descarga la aura. Puede ser un rango de valores. Puede tener múltiples valores separados por una coma o un espacio. Ejemplos: 2.º 5.º y 6.º eventos: 2, 5, 6 2.º a 6.º: 2-6 cada 2 eventos : /2 cada 3 eventos comenzando desde el 2: 2/3 cada 3 eventos comenzando desde el 2 y terminando en el 11: 2-11/3"
	...
	L["Rotated left"] = "Rotado a la izquierda"
	L["Rotated right"] = "Rotado a la derecha"
	...
	L["Shadow |c%sColor|r with offset |cFFFF0000%s/%s|r"] = "Sombra de |c%scolor|r con desplazamiento |cFFFF0000%s/%s|r"
	...
	L["Smooth Font"] = "Suavizado de fuente"
	L["Smooth Progress"] = "Progreso fluido"
	L["Smooth scaling"] = "Escalado suave"
	L["Smooths text height, preventing it from snapping to the nearest whole number when scaled."] = "Suaviza la altura del texto, evitando que se ajuste al número entero más cercano al escalarlo."
	L["Snippets"] = "Snippets"
...
Read more on our Patreon page https://patreon.com/WeakAuras]=] ] = "WeakAuras no será compatible con Midnight. Con el lanzamiento del preparche, WeakAuras quedará desactivado. Lee más en nuestra página de Patreon https://patreon.com/WeakAuras"
	L["What do you want to do?"] = "¿Qué es lo que quieres hacer?"
	L["Whole Area"] = "Área completa"
	L["Width |cFFFF0000%s|r and %s"] = "Ancho |cFFFF0000%s|r y %s"
